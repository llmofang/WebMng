    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[8].innerHTML = '<a class="cancel" href="">删除</a>';
            }
            ...
            var oTable = $('#editable-account').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, -1],
            ...
            $('#editable-account a.delete').live('click', function (e) {
                e.preventDefault();
            ...
            $('#editable-account a.cancel').live('click', function (e) {
                e.preventDefault();
            ...
            $('#editable-account a.edit').live('click', function (e) {
                e.preventDefault();
